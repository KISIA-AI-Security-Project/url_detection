...
# ---- Raw Evidence, Analysis Record 저장 (storage.py) ----

# Evidence를 저장할 기본 루트 디렉터리 (상대경로 = 실행 위치 기준).
# 이 아래에 raw/{job_id}/{attempt_id}/l2/*.json 과 records/{job_id}/{attempt_id}/l2.json이 생긴다.
# 배포에서는 S3 bucket이 이 루트를 대신한다 (storage_s3.py)
